...
var player1 = new Player("Fer", "rosa");
var player2 = new Player("Stan", "azul");
var player3 = new Player("Marco", "cappuccino");
...
class Game {
  constructor() {
    // --- Initialization of players ---
    let player1 = new Player("Fer", "rosa");
    let player2 = new Player("Stan", "azul");
    let player3 = new Player("Marco", "cappuccino");
